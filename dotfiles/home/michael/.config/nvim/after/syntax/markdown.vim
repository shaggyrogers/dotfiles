...
" ============
"
" Description:           Markdown syntax tweaks.
" Author:                Michael De Pasquale
" Creation Date:         2018-02-20
" Modification Date:     2019-12-11
"
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
syntax match mkdListItem '\m\(^\s\{0,4}\)\@3<=[*+]\([*\-+]\)\@1!' conceal cchar=⦁
syntax match mkdListItem '\m\(^\s\{0,4}\)\@3<=[\-]\([*\-+]\)\@1!' conceal cchar=⚊
